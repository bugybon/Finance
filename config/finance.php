...
return [
    'currency' => 'EUR',
    'sms_templates' => [
        'Purchase of EUR {amount} with {card} at {brand},',
        'Payment of EUR {amount} to {brand} with {card}.',
        '{brand} of EUR {amount} has been credited into ',
        'EUR {amount} has been debited from {account} using {card} at {brand} on {date} {time}.',
        '{brand} of EUR {amount} has been credited to your {account} on {date} {time}.',
        'Your {brand} of EUR {amount} has been credited to your {account} on {date} {time}.',
        'Outward {brand} of EUR {amount} is debited from your {account}. Your {card} as of {date} {time}.',
        'An ATM cash {brand} of EUR{amount} has been debited from your {account} on {date} {time}.',
        '{brand} PAYMENT for {card} via MOBAPP of EUR {amount} was debited from {date} {time}.',
        'Your Cr.Card {card} was used for EUR{amount} on {date} {time} at {brand},{ignore}. {ignore}',
    ],
    'reports' => [
